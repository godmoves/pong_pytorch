...
class PongGame:
    ...
    def getPresentFrame(self):
        ...
        drawScore(self.get, self.miss, self.hit_rate_100)
        # updates the window
        pygame.display.flip()
    ...
    def getNextFrame(self, action):
        ...
        if len(self.recent_100) == 0:
            hit_rate = 0
            hit_rate_100 = 0
        else:
            hit_rate = self.get / (self.get + self.miss)
            hit_rate_100 = (sum(self.recent_100) + len(self.recent_100)) / (2 * len(self.recent_100))
        self.hit_rate_100 = hit_rate_100
